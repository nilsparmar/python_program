...
class System_data:
	...
	def check_vm(self, vm_name):

		all_vm = self.my_data
		self.vm_name = vm_name

		lenth = len(all_vm['value'])
		#print(lenth)	

		for vm in range(lenth - 1):

			if vm_name == all_vm['value'][vm]['name']:
				print(vm_name)
				return True
...
ob1 = System_data(ip, username, password)

exist = ob1.check_vm('Centos-75-tb-22')
print(exist)

exist2 = ob1.check_vm('vm not in the list')
print(exist2)
